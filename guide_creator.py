...
# H for horisontal (-) gudes and V for vertical (|) gudes followed by numbers (indegers or floats)
# describing guide's position starting from the top left corner of the image.
# Position can be percent or pixels, depending on the option "Use percent/pixels"
# Example: H25V25H50
...
# The rest of the oprions use active layer or selection bounds as reference.
